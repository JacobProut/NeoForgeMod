...
public class SkeletalZombieAnimations {
    public static final AnimationDefinition SKELETAL_ZOMBIE_ATTACK = AnimationDefinition.Builder.withLength(0.5417F)
            .addAnimation("RightArm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.2083F, KeyframeAnimations.degreeVec(-67.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    ...
                    new Keyframe(0.3333F, KeyframeAnimations.degreeVec(-107.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    ...
                    new Keyframe(0.4583F, KeyframeAnimations.degreeVec(-100.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
